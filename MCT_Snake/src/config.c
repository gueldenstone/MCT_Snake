...
void TIM_Config(void){
	...
	TIM6->PSC = 71; 							// Prescaler setzten, ARR in µs
	...
	//Timer 7, Delay Timer
	TIM7->PSC = 71; 							// Prescaler setzten, ARR in µs
...
void ADC_Config(void){
	...
	ADC1->SMPR1 |= 0b111 << ADC_SMPR1_SMP0_Pos;	// Channel 1: Sample time 601.5 = 8,35µs @ 72MHz
	ADC1->SMPR1 |= 0b111 << ADC_SMPR1_SMP1_Pos; // Channel 2: Sample time 601.5 = 8,35µs @ 72MHz
