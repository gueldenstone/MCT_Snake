...
void RCC_Config(void){
	...
	/* Peripherie Clock */
  	...
  	//Timer
  	RCC->APB1ENR |= RCC_APB1ENR_TIM6EN | RCC_APB1ENR_TIM2EN | RCC_APB1ENR_TIM7EN; //Enable Timer 2 & 6 Clock
...
void ADC_Config(void){
	...
	ADC1->SMPR1 |= 0b111 << ADC_SMPR1_SMP0_Pos;	// Channel 1: Sample time 601.5 ns
	ADC1->SMPR1 |= 0b111 << ADC_SMPR1_SMP1_Pos; // Channel 2: Sample time 601.5 ns
...
void DMA_Config(void){
	...
	DMA1_Channel1->CMAR = (uint32_t)dma;											// Memory address setzten auf Array "dma"
